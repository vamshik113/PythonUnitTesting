...
class UnitT(unittest.TestCase):
    ...
    def test_input(self): #test to check whether input_testing function raises exception if negative values are given as input
        self.assertRaises(Exception, vSens1.input_testing,58156,0,1,1)
